...
import { CountryDetailsBasicDataComponent } from './country-details/country-details-basic-data/country-details-basic-data.component';
...
export const countryComponents = [
  ...
  CountryDetailsBasicDataComponent,
